        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (dBarState)
            {
                case DownloadBarState.Setup:
                    g.DrawImage(Properties.Resources.dbar_setup, 0, 0 , 500, 43);
                    g.DrawImage(Properties.Resources.red_progressbar, 5, 29, (int)((Value / 100) * this.Width), 10);
                    break;

                case DownloadBarState.Available:
                    g.DrawImage(Properties.Resources.dbar_available, 0, 0, 500, 43);
                    g.DrawImage(Properties.Resources.yellow_progressbar, 5, 29, (int)((Value / 100) * this.Width), 10);
                    break;

                case DownloadBarState.Playable:
                    g.DrawImage(Properties.Resources.dbar_playable, 0, 0, 500, 43);
                    g.DrawImage(Properties.Resources.DownloadProgressBarGreen, 5, 29, (int)((Value / 100) * this.Width), 10);
                    break;
            }
        }
