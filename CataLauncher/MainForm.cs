...
namespace CataLauncher
{
    public partial class MainForm : Form
    {
        ...
        {
            exitPictureBox.Image = Properties.Resources.close_hover;
        }

        private void MinimizePictureBox_MouseEnter(object sender, EventArgs e)
        {
            MinimizePictureBox.Image = Properties.Resources.mini_hover;
        }

        private void exitPictureBox_MouseLeave(object sender, EventArgs e)
        {
            exitPictureBox.Image = Properties.Resources.close;
        }

        private void MinimizePictureBox_MouseLeave(object sender, EventArgs e)
        {
            MinimizePictureBox.Image = Properties.Resources.mini_nohover;
        }
        ...
        {
            playButtonPictureBox.Image = Properties.Resources.play;
        }
        ...
        {
            playButtonPictureBox.Image = Properties.Resources.play_disabled;
            ...
            if (!string.IsNullOrEmpty(Settings.Default.WebsiteUrl))
            {
                ...
                btn.Name = "webButton";
                btn.ButtonText = "Homepage";
                btn.Location = new Point((97 * btnCtr) + 50, 469);
